...
DijkstraNode::DijkstraNode() :
	pos_{-1,-1}, endFlag_{false},totalCost_{std::numeric_limits<int>::max()}, beforPos_{-1,-1}
{
}
...
void DijkstraNode::PushNextNode(DijkstraNode* node)
{
...
void DijkstraNode::SetPos(const Math::Vector2I& pos)
{
	pos_ = pos;
}
